            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item nav_home">
                        <a class="nav-link hover-bar home_link" href="{{ route('index') }}"><i
                    ...
                    <li class="nav-item nav_signup">
                        <a class="nav-link hover-bar" href="{{ route('register') }}"><i
                                class="fa fa-user-plus fa-lg p-1"></i>{{ __('navbar.register') }}</a>
                    </li>
                    ...
                    <li class="nav-item nav_login">
                        <a class="nav-link hover-bar" href="{{ route('contact') }}">{{ __('navbar.contact') }}</a>
                    </li>

                    <li class="nav-item nav_login">
                        <a class="nav-link hover-bar" href="{{ route('privacy') }}">{{ __('navbar.privacy') }}</a>
                    </li>
